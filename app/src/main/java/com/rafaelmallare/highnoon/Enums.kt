...
enum class EquipmentType(val equipSlot: EquipSlot) {
    ARMOR(BODY), SHIELDS(OFFHAND), HELMET(HEAD), MELEE(PRIMEHAND), RANGED(PRIMEHAND)
}

enum class EquipmentSubType {
    UNARMED, ONEHAND, TWOHAND, HALFHAND, LONG, THROWN, PISTOL, RIFLE, SHOTGUN, ARCHERY, SPECIAL
}
